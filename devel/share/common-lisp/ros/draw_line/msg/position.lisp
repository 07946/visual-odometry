...
(cl:defmethod cl:initialize-instance :after ((m <position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name draw_line-msg:<position> is deprecated: use draw_line-msg:position instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader draw_line-msg:angle-val is deprecated.  Use draw_line-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'p-val :lambda-list '(m))
(cl:defmethod p-val ((m <position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader draw_line-msg:p-val is deprecated.  Use draw_line-msg:p instead.")
  (p m))
